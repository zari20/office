<div class="collapse show" id="collapseCourse" data-parent="#reserves-collapseable">
    ...
    <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="teachers" name="teachers" value="{{old('teachers')}}">
        </div>
        <div class="form-group col-md-4">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="file" class="form-control" id="file_path" name="file_path" value="{{old('file_path')}}" >
        </div>
    </div>
    <hr>
</div>
